...
import com.jmev.cn.constant.BusiConstant;
...
public class Page implements Serializable {
	...
	/** 默认每页记录数 */
	public static final int DEFAULT_PAGE_SIZE = BusiConstant.PAGE_SIZE;
	
	/**默认当前页*/
	public static final int DEFAULT_PAGE_INDEX = BusiConstant.PAGE_INDEX;
