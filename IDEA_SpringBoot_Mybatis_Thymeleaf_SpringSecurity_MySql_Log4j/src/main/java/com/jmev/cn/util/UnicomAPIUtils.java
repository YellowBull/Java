 ...
 * @author 邵欣
 */
public abstract class UnicomAPIUtils implements ApiClientConstant
{
    ...
    {
        String argArr[] =
        { LICENSE_KEY, USERNAME, PASSWORD, "89860117770003376307" };// iccid
        if (argArr.length != 4)
        {
    ...
    public UnicomAPIUtils(String url, String licenseKey)
