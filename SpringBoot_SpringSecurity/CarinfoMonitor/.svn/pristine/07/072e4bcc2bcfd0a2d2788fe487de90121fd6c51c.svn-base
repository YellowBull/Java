...
import com.jmev.cn.dao.crud.dao.GenericDao;
...
public abstract class GenericDaoSupport<T extends BaseEntity> implements GenericDao<T>
{
    ...
    protected void prepareObjectBeforeSaveOrUpdate(T entity)
    {
        ...
        // 如果是自动生成的16进制string id
        //		if (StringUtils.isEmpty(entity.getId())) {
        //			entity.setFirstInsert(date.toDate());
        //		}
        //
        //		entity.setLastModified(date.toDate());
...
//        }
     ...
     * @return void
     */
    protected void executeVoidProcedure(String pd, Object... values)
    {
        dao.executeVoidProcedure(pd, values);
    }
     ...
     */
    protected List<Map<String, Object>> executeSingletonProcedure(String pd, Object... values)
    {
        return dao.executeSingletonProcedure(pd, values);
    }
     ...
     * @return List<Map<String, Object>>
     */
    protected Map<String, Object> executeOutParamProcedure(String pd, String outParam, Integer outParamType,
            Object... ins)
    {
        return dao.executeOutParamProcedure(pd, outParam, outParamType, ins);
    }
}
